...
export default function hotReleaseClient({
  throttle,
  baseUrl,
  gitHtml = function({ message, commit, date }) {
  ...
  if (typeof gitHtml !== 'function') {
    logger.error('gitHtml should be a function,but got', typeof gitHtml)
  }
  addGitInfo(gitHtml)
